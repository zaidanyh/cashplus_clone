...
class GetDistrict(
    ...
    operator fun invoke(city: String): Flow<DataState<List<LocationList>>> = flow {
        ...
        try {
            ...
            val response = repository.getDistrict(LocationRequest(uuid = uuid, name = city), accessToken)
