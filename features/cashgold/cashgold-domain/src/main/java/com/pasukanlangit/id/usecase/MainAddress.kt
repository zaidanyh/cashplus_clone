...
class MainAddress(
    ...
    operator fun invoke(): Flow<DataState<Address>> = flow {
        ...
        try {
            ...
            emit(DataState.data(data = response.singleOrNull { it.isDefault } ?: addressEmpty))
        }catch (e: Exception){
    ...
    companion object {
        val addressEmpty = Address("","","","",-12,false, "", "", "")
    }
}