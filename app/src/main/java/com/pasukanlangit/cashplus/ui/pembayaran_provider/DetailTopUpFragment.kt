...
import com.pasukanlangit.cashplus.databinding.FragmentDetailTopUpProviderBinding
...
class DetailTopUpFragment : BottomSheetDialogFragment() {

    private var _binding: FragmentDetailTopUpProviderBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentDetailTopUpProviderBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        with(binding) {
            Glide.with(requireContext())
                .load(productModel?.img_url_2?.ifEmpty { productModel?.img_url })
    ...
    companion object {
        ...
        @JvmStatic
        fun newInstance(productModel: ProductModel, phoneNumber: String) =
            DetailTopUpFragment().apply {
