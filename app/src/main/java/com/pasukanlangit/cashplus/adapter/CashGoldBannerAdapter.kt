...
class CashGoldBannerAdapter(private val listBanner : List<BannerDummy>, val listener : (BannerDummy, Array<Pair<View, String>>) -> Unit): RecyclerView.Adapter<CashGoldBannerAdapter.BannerViewHolder>() {
